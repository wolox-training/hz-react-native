...
describe('withFlowDetermination', function () {
  it('Handles correctly the flow determination', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return store.dispatch({
              ...
              injections: (0, _2.default)(function (response) {
                return response.ok;
              })
            });
          ...
          case 7:
            ...
            expect(actionsDispatched).toEqual([{ type: actions.FETCH, target: 'aTarget' }, { type: actions.FETCH_SUCCESS, target: 'aTarget', payload: 42 }, { type: actions.FETCH, target: 'aTarget' }, { type: actions.FETCH_FAILURE, target: 'aTarget', payload: 'CLIENT_ERROR' }, { type: actions.FETCH, target: 'aTarget' }, { type: actions.FETCH_SUCCESS, target: 'aTarget', payload: 39 }]);

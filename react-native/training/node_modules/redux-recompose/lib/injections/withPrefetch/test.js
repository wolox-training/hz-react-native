...
var actions = (0, _createTypes2.default)(['FETCH', 'FETCH_SUCCESS', 'FETCH_FAILURE', 'FETCH_LOADING'], '@TEST');

describe('withPreFetch', function () {
  it('Handles correctly the prefetch behavior', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return store.dispatch({
              ...
              injections: (0, _2.default)(function (dispatch) {
                return dispatch({ type: actions.FETCH_LOADING });
              })
            });
          ...
          case 3:
            ...
            expect(actionsDispatched).toEqual([{ type: actions.FETCH_LOADING }, { type: actions.FETCH_SUCCESS, target: 'aTarget', payload: 42 }]);

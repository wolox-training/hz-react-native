...
describe('withPostSuccess', function () {
  it('Handles correctly post success', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            expect(actionsDispatched).toEqual([{ type: actions.FETCH, target: 'aTarget' }, { type: actions.FETCH_SUCCESS, target: 'aTarget', payload: 42 }, { type: actions.OTHER_ACTION }]);

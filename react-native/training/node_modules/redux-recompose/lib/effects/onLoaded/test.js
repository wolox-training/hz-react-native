...
var _onLoading = require('../onLoading');
...
describe('onLoaded', function () {
  it('Sets correctly loading target', function () {
    var reducer = (0, _createReducer2.default)(setUp.state, {
      '@@ACTION/TYPE_LOADED': (0, _2.default)(),
      '@@ACTION/TYPE_LOADING': (0, _onLoading2.default)()
    });
    var newState = reducer(setUp.state, { type: '@@ACTION/TYPE_LOADING', target: 'target' });
